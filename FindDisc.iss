//  Mortyr (2093-1944)
//  Modified for Mortyr (2093-1944) by SuicideMachine
...
begin
	...
	begin
		...
		begin
			if MsgBox('Is there a Mortyr CD in your computer? If not, please insert it and press OK.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
